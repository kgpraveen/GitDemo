...
public class AddressBookController {
   ...
   */
    ...
    public Boolean validate(){
        ...
        if (name==null||name.equals("")||length==0)
        ...
        try{
             ...
             if(length<10)
                JOptionPane.showMessageDialog(new JFrame(), "Mobile Number should have 10 digits","Inane error", JOptionPane.ERROR_MESSAGE);
            else 
                valid = true;
        }
        catch(NumberFormatException e ){
            JOptionPane.showMessageDialog(new JFrame(), "only numbers are allowed in mobile no","Inane error", JOptionPane.ERROR_MESSAGE);
            temp=temp+1;        
        }
        //if(length<10)
         //   JOptionPane.showMessageDialog(new JFrame(), "Mobile Number should be of size 10","Inane error", JOptionPane.ERROR_MESSAGE);
        //else 
        //    valid = true;
        }}
        return valid;
